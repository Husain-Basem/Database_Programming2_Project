...
?>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="email-tab" data-bs-toggle="tab" data-bs-target="#email-tab-pane" type="button" role="tab" aria-controls="email-tab-pane" aria-selected="false">Change Email</button>
  </li>
  <li class="nav-item" role="presentation">
...
<div class="tab-content" id="myTabContent">
  ...
  <div class="tab-pane fade" id="desc-tab-pane" role="tabpanel" aria-labelledby="desc-tab" tabindex="0">
    <h2>Change Description</h2>
        <form action="change_desc.php" method="post" class="needs-validation">
          <div class="form-floating mb-3">
            <textarea class="form-control" name="desc" id="desc" 
                      style="height: 200px;" placeholder="place your description"
  ...
  <div class="tab-pane fade" id="email-tab-pane" role="tabpanel" aria-labelledby="email-tab" tabindex="0">
        <h2>Change Email</h2>
        <form action="change_email.php" method="post" class="needs-validation">
          <div class="mb-3">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="delete_account.php" method="post">
          <label class="mb-3" for="submitted">Are you sure you want to delete your account? This action is not reversible.</label>
          <button class="btn btn-danger" type="submit" name="submitted" value="submitted">Delete account permanently</button>
